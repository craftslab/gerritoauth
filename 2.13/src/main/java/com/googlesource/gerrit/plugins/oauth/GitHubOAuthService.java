...
class GitHubOAuthService implements OAuthServiceProvider {
  ...
  public OAuthUserInfo getUserInfo(OAuthToken token) throws IOException {
    ...
    // GitHub now requires Authorization and User-Agent headers for /user.
    request.addHeader("Authorization", "token " + token.getToken());
    request.addHeader("User-Agent", "gerrit-oauth-provider");
